...
const paragraphs = [
  ...
  `Babbbbb, finally mai batana chahta hu mera pyaar aapke liye bohot bohot zyaada hai and it really even matters so much. Aap mere liye bohot kuch karey ho, aap mere liye itna pray karte ho, itna kuch care karte ho, and still I fail to love you the way you wanted. And haa bhai mai bhi maanta hu ki 8 mahine mein itna toh mereko samaj aana chahiye tha. See mai batata, jaha tak maine think karke thoda bohot figure out kara... see, jab bhi apan ache rehte, sab sahi chal rha hota, tab mereko aisa lagta ki haa ab toh we are good, we are happy with each other. But mai aise he kuch galat kar deta, aapko hurt ho jata. Toh mai wahi soch rha ki aage aisa kuch na karu, aapko woh pyaar du, aapko woh feel karwau ki yes he is the one, because I really feel that thing da, I really feel yes she is the onee!!`,
];
...
export default function Phase5() {
  ...
  useEffect(() => {
    ...
    paragraphs.forEach((_, i) => {
      timers.push(setTimeout(() => setVisible(i + 1), startDelay + 500 + i * 2000)); // Slower reading pace
    });

    const base = startDelay + 500 + paragraphs.length * 2000;
  ...
  return (
    ...
    >
      {/* Dynamic Background Only when Letter is Open */}
      {isOpen && <FloatingOrbs />}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            key="letter-content"
            style={{ width: '100%', maxWidth: '680px', paddingBottom: '2rem', zIndex: 10 }}
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                boxShadow: '0 12px 48px rgba(233,30,99,0.15), 0 2px 12px rgba(0,0,0,0.05)',
                  ...
                  <AnimatePresence key={i}>
                    {i < visible && (
                      <motion.p
                        ...
                        transition={{ duration: 1.5, ease: 'easeOut' }} // Ink reveal
                      >
                  ...
                  {showClosing && (
                    ...
                    >
                      ...
                      <motion.p
                        ...
                        animate={{ scale: [1, 1.03, 1], textShadow: ['0 0 0px rgba(233,30,99,0)', '0 0 20px rgba(233,30,99,0.3)', '0 0 0px rgba(233,30,99,0)'] }}
